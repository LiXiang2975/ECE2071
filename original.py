...
if mode == 1:
    ...
    while time.time() <end_time:
        x = ser.read() #read 5000 bytes over UART
...
outputFileSize = os.path.getsize("raw_ADC_values.data")
...
codeOutput = subprocess.getstatusoutput(f"ADCtoWAV raw_ADC_values.data recording.wav {outputFileSize}") #runs the executable with command line arguments
